                    ...
                    <div class="">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Formulário de usuários <small>Formulário para cadastro e edição de usuários</small></h2>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="hidden" id="tipo" name="tipo" value="M" required="required" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <a href="listausuario.jsp" class="btn btn-primary">Voltar</a>
                                                </div>
                                            </div>
