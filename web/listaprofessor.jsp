...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="js/professor/index.js"></script>
    </head>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <input type="button" id="btnnovo" value="Novo" onclick="location.href = 'formprofessor.jsp'" class="btn btn-primary"><br/><br/>
